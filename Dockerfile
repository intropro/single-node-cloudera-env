...
ENV PARCELDIRDOWNLOAD http://archive.cloudera.com/cdh5/parcels/5.3.3/
ENV PARCELFILENAME CDH-5.3.3-1.cdh5.3.3.p0.5-el6.parcel
...
# Download parcel
RUN wget --progress=dot:mega -P $PARCELCACHE $PARCELDIRDOWNLOAD/$PARCELFILENAME && \
    wget --progress=dot:mega -P $PARCELCACHE $PARCELDIRDOWNLOAD/$PARCELFILENAME.sha1 && \
